...
function renderSuccess() {
    return stage(`<div class="success-content"><div class="success-badge" aria-hidden="true"><i class="bi bi-check2"></i></div><p class="onboarding-kicker">Account created</p><h1 class="onboarding-title">Your plan is ready.</h1><p class="onboarding-copy">Download UPlate and sign in with the same account to see your personalized plan.</p><p class="welcome-credit"><i class="bi bi-stars" aria-hidden="true"></i><span><strong>One week of UPlate Pro, free.</strong>Your trial begins after you sign in.</span></p><div class="download-actions"><a class="download-button download-button--primary" href="${APP_STORE_URL}"><i class="bi bi-apple"></i><span>Download on the App Store</span><i class="bi bi-arrow-up-right download-button__arrow" aria-hidden="true"></i></a><a class="download-button" href="${PLAY_STORE_URL}"><i class="bi bi-android2"></i><span>Get it on Google Play</span><i class="bi bi-arrow-up-right download-button__arrow" aria-hidden="true"></i></a></div></div>`, true)
}
